            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Cetak KIB Tanah</li>
                    </ol>
                </div>
                <h4 class="page-title">Cetak KIB Tanah</h4>
            </div>
        </div>
    </div>     
    <!-- end page title -->
                        ...
                        <div class="table-wrapper">
                            <div class="btn-toolbar">
                                <div class="btn-group focus-btn-group mb-2">
                                    ...
                                    <form class="form-inline">
                                        <div class="input-group mb-3 mr-3">
                                            <label>Cetak untuk&nbsp;&nbsp;</label>
                                            <select class="form-control" name="id_opd">
                                                <option value="">Semua OPD</option>
                                                @foreach($dataview->daftar_opd as $opd)
                                                <option value="{{ $opd->id_opd }}" {{ $dataview->id_opd == $opd->id_opd ? 'selected' : '' }}>[{{ strtoupper($opd->singkatan_opd) }}] {{ $opd->nama_opd }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="btn-group dropdown-btn-group pull-right">
                                    ...
                                    <form action="{{ route('admin.kib.tanah.print') }}" target="_blank" class="form-inline">
                                        <div class="input-group mb-3 mr-3">
                                            <input type="hidden" name="id_opd" value="{{ $dataview->id_opd }}">
                                            <div class="input-group">
                                                <button type="submit" class="input-group-text" id="basic-addon1"><i class="mdi mdi-printer"></i>&nbsp;&nbsp;Print</button>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                @forelse($dataview->datanya as $item)
                                    <tr>
                                        <td>{{ $nomor++ }}</td>
                                        <td>{!! highlight($item->nama_opd, $dataview->pencarian) !!}</td>
