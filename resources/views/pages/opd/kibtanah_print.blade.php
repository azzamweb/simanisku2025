    ...
    <div class="content">
        ...
        <div class="signature-container">
            <div class="signature-box">
                ...
                @if(strtoupper(Auth::guard('opd')->user()->nama_opd)=='SEKRETARIAT DAERAH')
                    <p><strong>SEKRETARIS DAERAH</strong></p>
                @else
                    <p><strong>KEPALA {{ strtoupper(Auth::guard('opd')->user()->nama_opd) }}</strong></p>
                @endif
                
                <br>
                <br>
                <br>
                <p class="left-side">{{ Auth::guard('opd')->user()->pejabat_tandatangan }}</p>
                <hr>
                <p class="left-side">NIP. {{ Auth::guard('opd')->user()->pejabat_tandatangan_nip }}</p>
            </div>
            <div class="signature-box">
                <p>Bengkalis, {{ tanggal_indonesia(date('Y-m-d')) }}</p>
                <p><strong>PENGURUS BARANG {{ strtoupper(Auth::guard('opd')->user()->nama_opd) }}</strong></p>
                <br>
                <br>
                <br>
                <p class="left-side">{{ Auth::guard('opd')->user()->pengurus_barang }}</p>
                <hr>
                <p class="left-side">NIP. {{ Auth::guard('opd')->user()->pengurus_barang_nip }}</p>
            </div>
        </div>
